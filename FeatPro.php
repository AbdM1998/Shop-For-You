	...
	<section class="sectionprduct ">
		<div class="container">
			...
			<div class="row">
	      	...
	      	$getAllproduct = $pd->getALLFeaturedProduct();
	      			if($getAllproduct){
	      		while ($result = $getAllproduct->fetch_assoc()) {

    			?>
				<div class="col-lg-3 col-md-6 col-sm-12" style="display: inherit;">
					<div class="card" style="width: 19rem;"  >
						<a href="preview.php?proid=<?php echo $result['productID']; ?>"><img style="    height: 220px;" src="admin/<?php echo $result['image']; ?>" class="card-img-top" alt="..." ></a>
					<div class="card-body">
