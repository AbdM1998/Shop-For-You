       ...
       <div class="card mb-3" style="margin-left: 5px!important">
            <div class="card-header" style="margin-bottom: 5px;">
              <i class="fas fa-table"></i>
                <h5 style="display: inline-block;">New Customer List</h5>
                <div class="block">
					...
					<tbody>
						...
						$getNewCustmerData = $user->getNewCustmerData();
						

						
						if($getNewCustmerData){
							$i = 0;
							while ($result = $getNewCustmerData->fetch_assoc()) {
